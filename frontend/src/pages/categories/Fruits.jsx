...
export const Fruits = ({ isLoggedIn }) => {
  ...
  const fruitItems = products.filter(
    (item) => item.category === "Fresh Fruits"
  );
  ...
  return (
    <div className="w-full">
      ...
      {/* HEADER */}
      <div className="w-full bg-orange-50/50 py-8 lg:py-12 border-b border-orange-100 mb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-800 tracking-tight leading-tight">
            Crisp & <span className="text-orange-600">Fresh Fruits</span>
          </h1>
          <p className="text-slate-500 font-bold text-sm mt-4 max-w-xl leading-relaxed">
            Hand-picked, seasonal, and fresh fruits bursting with flavor and natural goodness.
          </p>
        </div>
      </div>
